...
ggplot(example2$msi, aes(x = c(1989:2017), y = mean_msi_final))+
  geom_ribbon(aes(ymin = mean_msi_final-sd_msi_final, ymax = mean_msi_final+sd_msi_final), fill = "lightgrey")+
    ...
    stat_function(fun = function(x){example2$coef$alpha2*x^2+example2$coef$alpha1*x+example2$coef$inter-1.96*example2$coef$strd/sqrt(niter)},linetype="dashed")+
    stat_function(fun = function(x){example2$coef$alpha2*x^2+example2$coef$alpha1*x+example2$coef$inter+1.96*example2$coef$strd/sqrt(niter)},linetype="dashed")+
    ...
    geom_segment(x=example2$coef$p_1+1.96*example2$coef$sd_p_1,y=0,aes(xend=example2$coef$p_1+1.96*example2$coef$sd_p_1/sqrt(niter),yend=min(abs(example2$msi$mean_msi_final))),color="red", linetype="dashed")+
    geom_segment(x=example2$coef$p_1-1.96*example2$coef$sd_p_1,y=0,aes(xend=example2$coef$p_1-1.96*example2$coef$sd_p_1/sqrt(niter),yend=min(abs(example2$msi$mean_msi_final))),color="red", linetype="dashed")+
    ...
    geom_segment(x=example2$coef$p_2+1.96*example2$coef$sd_p_2,y=0,aes(xend=example2$coef$p_2+1.96*example2$coef$sd_p_2/sqrt(niter),yend=min(abs(example2$msi$mean_msi_final))),color="blue", linetype="dashed")+
    geom_segment(x=example2$coef$p_2-1.96*example2$coef$sd_p_2,y=0,aes(xend=example2$coef$p_2-1.96*example2$coef$sd_p_2/sqrt(niter),yend=min(abs(example2$msi$mean_msi_final))),color="blue", linetype="dashed")+
    ...
    geom_segment(x=example2$coef$p_3+1.96*example2$coef$sd_p_3,y=0,aes(xend=example2$coef$p_3+1.96*example2$coef$sd_p_3/sqrt(niter),yend=min(abs(example2$msi$mean_msi_final))), color="blue", linetype="dashed")+
    geom_segment(x=example2$coef$p_3-1.96*example2$coef$sd_p_3, y=0,aes(xend=example2$coef$p_3-1.96*example2$coef$sd_p_3/sqrt(niter), yend=min(abs(example2$msi$mean_msi_final))),color="blue", linetype="dashed")
```